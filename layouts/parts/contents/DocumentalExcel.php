        ...
        <table id="customers">
            ...
            <tbody>
                ...
                foreach ($evaluationsData as $r) :
                    ...
                    $projeto = $r['projeto'];
                    $projetoNoAsps =  preg_replace("/[^a-zA-Z0-9]+/", " ", $projeto);
                    $proponente = $r['proponente'];
                    $categoria = $r['categoria'];
                    $municipio = $r['municipio'];
                    $resultado = $r['resultado'];
                    $motivo_inabilitacao = $r['motivo_inabilitacao'];
                    $motivo_inabilitacao_NoAsps =  preg_replace("/[^a-zA-Z0-9]+/", " ", $motivo_inabilitacao);
                ?>
                    <tr>
                        ...
                        <td><?php echo $projetoNoAsps; ?></td>
                        <td><?php echo $proponente; ?></td>
                        <td><?php echo $categoria; ?></td>
                        <td><?php echo $municipio; ?></td>
                        <td><?php echo $resultado; ?></td>
                        <td>
                            <?php echo $motivo_inabilitacao_NoAsps; ?>
                        </td>
